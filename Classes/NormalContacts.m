...
/***********************************************
	This manages the Normal contacts view (contacts not in Z-Zone)
...
#import "NormalContacts.h"

@implementation NormalContacts
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	...
	{
		case 0:
			return [[appDelegate.arrNormalCounts objectAtIndex:section] intValue];
			break;
		default:
			return [[appDelegate.arrNormalCounts objectAtIndex:section] intValue] - [[appDelegate.arrNormalCounts objectAtIndex:section-1] intValue];
			break;
	}
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	switch (indexPath.section) 
	{
		case 0:
			...
			break;
		default:
			intCurrentIndex = indexPath.row +  [[appDelegate.arrNormalCounts objectAtIndex:indexPath.section-1] intValue];
			break;
	}
	...
	{
		//Set non Z-Zone configuration
		cell.textLabel.textColor = [UIColor blackColor];
	}
	
	[[cell textLabel]setText:[[appDelegate.arrNormalContacts objectAtIndex:intCurrentIndex] objectAtIndex:1]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	arrContactText = [appDelegate.arrNormalContacts objectAtIndex:intCurrentIndex];
	...
	[appDelegate.arrNormalContacts replaceObjectAtIndex:intCurrentIndex withObject:[[NSArray alloc] initWithObjects:[arrContactText objectAtIndex:0], 
